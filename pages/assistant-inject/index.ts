...
/**
 * In the content script of tswebextension, we need access to @secureall/assistant
 * only when the user clicks 'block ad manually'.
 * Therefore, we exclude @secureall/assistant from the bundled content-script code
 ...
 */
import '@secureall/tswebextension/assistant-inject';
