...
window.locales = {
  "ar": { "adgAccessBlockedTitle": "تم حظره بواسطة SecureAll", "extAccessBlockedDesc": "تم حظر الوصول إلى <strong id='adgAccessBlockedHost'></strong> بواسطة قاعدة الفلترة", "filter": "فلتر", "rule": "قاعدة", "proceedAnyway": "المتابعة على أية حال", "copy": "نسخ", "close": "إغلاق", "backBtn": "الرجوع للخلف", "adgAccessBlockedFaqTitle1": "كيفية إلغاء حظر هذا الموقع؟", "adgAccessBlockedFaqDesc1": "يمكنك <button type='button' id='adgAccessAllowToWhiteList'>إضافة هذا الموقع إلى القائمة المسموح بها</button>" },
  "cs": { "adgAccessBlockedTitle": "Přístup blokován SecureAllem", "extAccessBlockedDesc": "Přístup k <strong id='adgAccessBlockedHost'></strong> byl zablokován pravidlem filtrování", "filter": "Filtr", "rule": "Pravidlo", "proceedAnyway": "Přesto pokračovat", "copy": "Kopírovat", "close": "Zavřít", "backBtn": "Zpět", "adgAccessBlockedFaqTitle1": "Jak odblokovat tuto webovou stránku?", "adgAccessBlockedFaqDesc1": "Můžete <button type='button' id='adgAccessAllowToWhiteList'>přidat tuto webovou stránku na seznam povolených</button>" },
  "da": { "adgAccessBlockedTitle": "Adgang blokeret af SecureAll", "extAccessBlockedDesc": "Adgang til <strong id='adgAccessBlockedHost'></strong> blokeret af en filtreringsregel", "filter": "Filter", "rule": "Regel", "proceedAnyway": "Fortsæt alligevel", "copy": "Kopiér", "close": "Luk", "backBtn": "Gå tilbage", "adgAccessBlockedFaqTitle1": "Hvordan afblokeres dette websted?", "adgAccessBlockedFaqDesc1": "Man kan <button type='button' id='adgAccessAllowToWhiteList'>føje dette websted til hvidlisten</button>" },
  "de": { "adgAccessBlockedTitle": "Zugriff durch SecureAll blockiert", "extAccessBlockedDesc": "Der Zugriff auf <strong id='adgAccessBlockedHost'></strong> wurde durch eine Filterregel blockiert", "filter": "Filter", "rule": "Regel", "proceedAnyway": "Trotzdem fortfahren", "copy": "Kopieren", "close": "Schließen", "backBtn": "Zurück", "adgAccessBlockedFaqTitle1": "Wie entsperre ich diese Website?", "adgAccessBlockedFaqDesc1": "Sie können <button type='button' id='adgAccessAllowToWhiteList'>diese Website zur Liste der zulässigen Websites hinzufügen</button>" },
  "en": { "adgAccessBlockedTitle": "Access blocked by SecureAll", "extAccessBlockedDesc": "Access to <strong id='adgAccessBlockedHost'></strong> was blocked by a filtering rule", "filter": "Filter", "rule": "Rule", "proceedAnyway": "Proceed anyway", "copy": "Copy", "close": "Close", "backBtn": "Go back", "adgAccessBlockedFaqTitle1": "How to unblock this website?", "adgAccessBlockedFaqDesc1": "You can <button type='button' id='adgAccessAllowToWhiteList'>add this website to allowlist</button>" },
  "es": { "adgAccessBlockedTitle": "Acceso bloqueado por SecureAll", "extAccessBlockedDesc": "El acceso a <strong id='adgAccessBlockedHost'></strong> fue bloqueado por una regla de filtrado", "filter": "Filtro", "rule": "Regla", "proceedAnyway": "Continuar así mismo", "copy": "Copiar", "close": "Cerrar", "backBtn": "Volver", "adgAccessBlockedFaqTitle1": "¿Cómo desbloquear este sitio web?", "adgAccessBlockedFaqDesc1": "Puedes <button type='button' id='adgAccessAllowToWhiteList'>agregar este sitio web a la lista de permitidos</button>" },
  "fa": { "adgAccessBlockedTitle": "دسترسی به <strong>مسدود شده</strong> توسط SecureAll", "extAccessBlockedDesc": "دسترسی به <strong id='adgAccessBlockedHost'></strong> توسط یک رویه‌های پالایش مسدود شده است", "filter": "فیلتر", "rule": "رویه", "proceedAnyway": "در هر صورت ادامه یابد", "copy": "روگرفت", "close": "بستن", "backBtn": "برگرد", "adgAccessBlockedFaqTitle1": "چگونه می‌توان این تارنما را رفع انسداد کرد؟", "adgAccessBlockedFaqDesc1": "شما می‌توانید <button type='button' id='adgAccessAllowToWhiteList'>این تارنما را به فهرست سفید اضافه کنید</button>" },
  "fi": { "adgAccessBlockedTitle": "SecureAll esti pääsyn", "extAccessBlockedDesc": "Pääsy <strong id='adgAccessBlockedHost'></strong> estettiin suodatussäännöllä", "filter": "Suodatin", "rule": "Sääntö", "proceedAnyway": "Jatka silti", "copy": "Kopioi", "close": "Sulje", "backBtn": "Palaa takaisin", "adgAccessBlockedFaqTitle1": "Miten sallia tämä verkkosivusto?", "adgAccessBlockedFaqDesc1": "Voit <button type='button' id='adgAccessAllowToWhiteList'>lisätä tämän verkkosivuston hyväksyntäluetteloon</button>" },
  "fr": { "adgAccessBlockedTitle": "Accès bloqué par SecureAll", "extAccessBlockedDesc": "L'accès à <strong id='adgAccessBlockedHost'></strong> a été bloqué par une règle de filtrage", "filter": "Filtre", "rule": "Règle", "proceedAnyway": "Procéder malgré tout", "copy": "Copier", "close": "Fermer", "backBtn": "Retour", "adgAccessBlockedFaqTitle1": "Comment débloquer ce site web ?", "adgAccessBlockedFaqDesc1": "Vous pouvez <button type='button' id='adgAccessAllowToWhiteList'>ajouter ce site web à la liste d'autorisation</button>" },
  "id": { "adgAccessBlockedTitle": "Akses terblokir oleh SecureAll", "extAccessBlockedDesc": "Akses ke <strong id='adgAccessBlockedHost'></strong> diblokir oleh aturan pemfilteran", "filter": "Pemfilteran", "rule": "Aturan", "proceedAnyway": "Bagaimana pun juga lanjutkan", "copy": "Salin", "close": "Tutup", "backBtn": "Kembali", "adgAccessBlockedFaqTitle1": "Bagaimana cara membuka blokir situs ini?", "adgAccessBlockedFaqDesc1": "Anda dapat <button type='button' id='adgAccessAllowToWhiteList'>menambahkan situs web ini ke daftar izinkan</button>" },
  "it": { "adgAccessBlockedTitle": "Accesso bloccato da SecureAll", "extAccessBlockedDesc": "L'accesso a <strong id='adgAccessBlockedHost'></strong> è stato bloccato da una regola di filtraggio", "filter": "Filtro", "rule": "Regola", "proceedAnyway": "Procedi comunque", "copy": "Copia", "close": "Chiudi", "backBtn": "Torna indietro", "adgAccessBlockedFaqTitle1": "Come sbloccare questo sito web?", "adgAccessBlockedFaqDesc1": "Puoi <button type='button' id='adgAccessAllowToWhiteList'>aggiungere questo sito web alla lista consentita</button>" },
  "ja": { "adgAccessBlockedTitle": "SecureAll によってアクセスがブロックされています", "extAccessBlockedDesc": "フィルタリングルールによって <strong id='adgAccessBlockedHost'></strong> へのアクセスがブロックされました。", "filter": "フィルタ", "rule": "ルール", "proceedAnyway": "そのままリンクを開く", "copy": "コピー", "close": "閉じる", "backBtn": "戻る", "adgAccessBlockedFaqTitle1": "このウェブサイトのブロックを解除する方法は？", "adgAccessBlockedFaqDesc1": "<button type='button' id='adgAccessAllowToWhiteList'>このウェブサイトをホワイトリストに追加する</button>ことができます。" },
  "ko": { "adgAccessBlockedTitle": "SecureAll에 의해 차단됨", "extAccessBlockedDesc": "<strong id='adgAccessBlockedHost'></strong> 에 대한 액세스가 필터링 규칙에 의해 차단되었습니다.", "filter": "필터", "rule": "규칙", "proceedAnyway": "그래도 계속 진행", "copy": "복사", "close": "닫기", "backBtn": "뒤로 가기", "adgAccessBlockedFaqTitle1": "이 웹사이트 차단을 해제하는 방법은 무엇인가요?", "adgAccessBlockedFaqDesc1": "<button type='button' id='adgAccessAllowToWhiteList'>이 웹사이트를 허용 목록</button>에 추가할 수 있습니다." },
  "lt": { "adgAccessBlockedTitle": "Prieiga užblokuota SecureAll", "extAccessBlockedDesc": "Prieiga prie <strong id='adgAccessBlockedHost'></strong> buvo užblokuota pagal filtravimo taisyklę", "filter": "Filtras", "rule": "Taisyklė", "proceedAnyway": "Tęsti vis tiek", "copy": "Kopijuoti", "close": "Uždaryti", "backBtn": "Grįžti atgal", "adgAccessBlockedFaqTitle1": "Kaip atblokuoti šią svetainę?", "adgAccessBlockedFaqDesc1": "Galite <button type='button' id='adgAccessAllowToWhiteList'>pridėti šią svetainę į leidžiamų sąrašą</button>" },
  "pl": { "adgAccessBlockedTitle": "Dostęp zablokowany przez SecureAll", "extAccessBlockedDesc": "Dostęp do <strong id='adgAccessBlockedHost'></strong> został zablokowany przez regułę filtrowania", "filter": "Filtr", "rule": "Reguła", "proceedAnyway": "Mimo wszystko kontynuuj", "copy": "Kopiuj", "close": "Zamknij", "backBtn": "Wróć", "adgAccessBlockedFaqTitle1": "Jak odblokować tę stronę?", "adgAccessBlockedFaqDesc1": "Możesz <button type='button' id='adgAccessAllowToWhiteList'>dodać tę witrynę do listy dozwolonych</button>" },
  "pt-BR": { "adgAccessBlockedTitle": "Acesso bloqueado pelo SecureAll", "extAccessBlockedDesc": "O acesso a <strong id='adgAccessBlockedHost'></strong> foi bloqueado por uma regra de filtragem", "filter": "Filtro", "rule": "Regra", "proceedAnyway": "Continuar mesmo assim", "copy": "Copiar", "close": "Fechar", "backBtn": "Voltar", "adgAccessBlockedFaqTitle1": "Como desbloquear este site?", "adgAccessBlockedFaqDesc1": "Você pode <button type='button' id='adgAccessAllowToWhiteList'>adicionar este site à lista de permissões</button>" },
