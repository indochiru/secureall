...
export const getExportedSettingsProtocolV1Fixture = () => ({
    ...
    'extension-specific-settings': {
        ...
        'show-info-about-secureall': false,
        'show-app-updated-info': true,
        'hide-rate-secureall': true,
    ...
    'filters': {
        ...
        'user-filter': {
            ...
            'rules': 'example.org##body\n||mail.ru^$first-party\nchampionat.com##.header\n\n\n!\n! Title: Rules for simple rules tests\n! Filter to be used for testing purposes\n! https://testcases.secureall.local\n! Hide warning\ntestcases.secureall.local,surge.sh###subscribe-to-test-simple-rules-filter\n! Test case 1: domain-specific elemhide rule\ntestcases.secureall.local,surge.sh###case-1-elemhide > .test-banner\n! Test case 2: generic elemhide rule\n###case-2-generic-elemhide > .test-banner\n! Test case 3: elemhide rule exception\n###case-3-elemhide-exception > .test-banner\ntestcases.secureall.local,surge.sh#@##case-3-elemhide-exception > .test-banner\n! Test case 3: wildcard exception\ntestcases.secureall.local,surge.sh###case-3-elemhide-exception > h1\n*#@##case-3-elemhide-exception > h1\n! Test case 3: generic exception\ntestcases.secureall.local,surge.sh###case-3-elemhide-exception > h2\n#@##case-3-elemhide-exception > h2\n! Test case 3: generic exception for generic elemhide\n###case-3-elemhide-exception > h3\n#@##case-3-elemhide-exception > h3\n! Test case 4: domain exclusion\n~testcases.secureall.local,~surge.sh###case-4-domain-exclusion > .test-banner\n! Test case 5: wildcard for tld\ntestcases.secureall.*,surge.*###case-5-wildcard-for-tld > .test-banner\n! Test case 6: wildcard for tld support with $domain modifier\n||*/tld-test-files/$image,domain=testcases.secureall.*|surge.*\n||*/tld*$script,domain=testcases.secureall.*|surge.*\n! Test case 6: $third-party modifier\n||antibanner.net^$third-party\n! Title: Rules for extended css rules test\ntestcases.secureall.local,surge.sh###subscribe-to-test-extended-css-rules-filter\ntestcases.secureall.local,surge.sh#?##case1.banner:has(a.banner-link)\ntestcases.secureall.local,surge.sh#?##case2.banner:contains(Click Me!)\ntestcases.secureall.local,surge.sh#?##case3.banner:matches-css(opacity: 0.9)\ntestcases.secureall.local,surge.sh#?##case4.banner:matches-css-after(content: sponsored)\ntestcases.secureall.local,surge.sh#?##case5.banner:matches-css-before(content: sponsored)\ntestcases.secureall.local,surge.sh#?##case6.banner:has-text(You would want to click me for sure!)\ntestcases.secureall.local,surge.sh#?##case7.banner:-abp-has(a.banner-link)\ntestcases.secureall.local,surge.sh#?##case8.banner:contains(Click Me!)\ntestcases.secureall.local,surge.sh#?##case9.banner:contains(/[aа]{20,}/)\ntestcases.secureall.local,surge.sh#?##case10.banner:matches-css(background-image: /url\\(data\\:image\\/svg\\+xml;base64,[A-Za-z0-9]{100,}/)\ntestcases.secureall.local,surge.sh#?##case11.banner:matches-css-after(background-image: /url\\(data\\:image\\/svg\\+xml;base64,[A-Za-z0-9]{100,}/)\ntestcases.secureall.local,surge.sh#?##case12.banner:matches-css-before(background-image: /url\\(data\\:image\\/svg\\+xml;base64,[A-Za-z0-9]{100,}/)\ntestcases.secureall.local,surge.sh#?#body #case13.banner[-ext-has="a.banner-link"]\ntestcases.secureall.local,surge.sh#?#.container > #case14.banner[-ext-contains="/[aа]{20,}/"]\ntestcases.secureall.local,surge.sh#?##case14 + #case15.banner[-ext-matches-css-after="content:sponsored"]\ntestcases.secureall.local,surge.sh#?##case1 ~ #case16.banner[-ext-matches-css-before="content:sponsored"]\ntestcases.secureall.local,surge.sh#?#*:contains(/absolute[\\s\\S]*-\\d{4}/) + * > .banner:contains(/а/) ~ #case17.banner:has(> div:contains(/а/):nth-child(100n + 2))\ntestcases.secureall.local,surge.sh#?#.test-xpath-case18:xpath(//*[@class="test-case18-div"]/../..)\ntestcases.secureall.local,surge.sh#?#.test-nth-ancestor-case19:nth-ancestor(3)\ntestcases.secureall.local,surge.sh#?#.test-upward-selector:upward(#case20)\ntestcases.secureall.local,surge.sh#?#.test-upward-number-case21:upward(4)\n! Case 22\ntestcases.secureall.local,surge.sh#?##inframe1:has(.content)\ntestcases.secureall.local,surge.sh#?##case23 > div:contains(/kick me!|\\(18\\+\\)|https:\\/\\/vk.cc|testTEXT|vk.com\\/test_id/)\ntestcases.secureall.local,surge.sh#?##case24 > div:matches-attr("/^data-.{4}$/"="/banner/")\ntestcases.secureall.local,surge.sh#?##case25 > div:matches-property("id"="/property-match/")\ntestcases.secureall.local,surge.sh#?##case26:remove()\ntestcases.secureall.local,surge.sh#$?##case27:has(div) { remove: true; }\ntestcases.secureall.local,surge.sh#?##case28 > :is(.case28, #main, footer, span):contains(isTest)\n! Title: Rules for $important rules test\ntestcases.secureall.local,surge.sh###subscribe-to-test-important-rules-filter\n! Case 1\n||*/test-files/adg1.png$important\n@@||*/test-files/adg1.png\n! Case 2\n||*/test-files/adg2.png$important\n@@||*/test-files/adg2.png$important\n! Title: Rules for $replace rules test\ntestcases.secureall.local,surge.sh###subscribe-to-test-replace-rules-filter\n! Case 1: text response\n||testcases.secureall.local/*/case1-text-response.txt$replace=/secureall/Test passed/i\n||surge.sh/*/case1-text-response.txt$replace=/secureall/Test passed/i\n! Case 2: response is more then 3MB\n||testcases.secureall.local/*/case2-response-over-3mb.txt$replace=/SecureAll/Replaced/i\n||surge.sh/*/case2-response-over-3mb.txt$replace=/SecureAll/Replaced/i\n! Case 3: using with other rules (without $replace modifier) for a same request\n||testcases.secureall.local/*/case3-using-with-other-rules.txt$replace=/secureall/Test passed/i\n||surge.sh/*/case3-using-with-other-rules.txt$replace=/secureall/Test passed/i\n||testcases.secureall.local/*/case3-using-with-other-rules.txt\n||surge.sh/*/case3-using-with-other-rules.txt\n! Case 4: multiple $replace rules matching a single request\n||testcases.secureall.local/*/case4-multiple-replace-rules.txt$replace=/secureall/first replace rule work/i\n||surge.sh/*/case4-multiple-replace-rules.txt$replace=/secureall/first replace rule work/i\n||testcases.secureall.local/*/case4-multiple-replace-rules.txt$replace=/team/and second as well/i\n||surge.sh/*/case4-multiple-replace-rules.txt$replace=/team/and second as well/i\n! Case 5: disabling $replace rules\n||testcases.secureall.local/*/case5-disabling-replace-rule.txt$replace=/secureall/first replace rule works/i\n||surge.sh/*/case5-disabling-replace-rule.txt$replace=/secureall/first replace rule works/i\n||testcases.secureall.local/*/case5-disabling-replace-rule.txt$replace=/team/and second as well/i\n||surge.sh/*/case5-disabling-replace-rule.txt$replace=/team/and second as well/i\n@@||testcases.secureall.local/*/case5-disabling-replace-rule.txt$replace\n@@||surge.sh/*/case5-disabling-replace-rule.txt$replace\n! Case 6: multiple $replace rules\n||testcases.secureall.local/*/case6-disabling-multiple-replace-rules.txt$replace=/secureall/first replace rule/i\n||surge.sh/*/case6-disabling-multiple-replace-rules.txt$replace=/secureall/first replace rule/i\n||testcases.secureall.local/*/case6-disabling-multiple-replace-rules.txt$replace=/works/works and second as well/i\n||surge.sh/*/case6-disabling-multiple-replace-rules.txt$replace=/works/works and second as well/i\n@@||testcases.secureall.local/*/case6-disabling-multiple-replace-rules.txt$replace=/works/works and second as well/i\n@@||surge.sh/*/case6-disabling-multiple-replace-rules.txt$replace=/works/works and second as well/i\n! Case 7: using with $script exception modifier for a same request\n||testcases.secureall.local/*/case7-content-type-modifier.js$replace=/tmp\\s+\\=\\s+0/tmp = 1/i\n||surge.sh/*/case7-content-type-modifier.js$replace=/tmp\\s+\\=\\s+0/tmp = 1/i\n||testcases.secureall.local/*/case7-content-type-modifier.js$script\n||surge.sh/*/case7-content-type-modifier.js$script',
            'disabled-rules': '',
        },
        'whitelist': {
            'enabled': true,
...
export const getImportedSettingsFromV1Fixture = () => {
    ...
    if (__IS_MV3__) {
        configV1.filters['enabled-filters'] = configV1.filters['enabled-filters']
            .filter((id) => {
                // 14 - SecureAll Annoyances filter has been splitted into 5 other filters: Cookie Notices, Popups, Mobile
                // App Banners, Other Annoyances and Widgets
                // 15 - SecureAll DNS filter - not supported in MV3.
        ...
        //     0,
        //     // 24 - SecureAll Quick Fixes enabled by default for MV3.
        //     24,
        // );
...
export const getExportedSettingsProtocolV2Fixture = (): Config => ({
    ...
    [RootOption.ExtensionSpecificSettings]: {
        ...
        [ExtensionSpecificSettingsOption.ShowInfoAboutSecureAll]: false,
        [ExtensionSpecificSettingsOption.ShowAppUpdatedInfo]: true,
        [ExtensionSpecificSettingsOption.HideRateSecureAll]: true,
