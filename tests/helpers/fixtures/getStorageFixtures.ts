...
import { FilterListPreprocessor } from '@secureall/tsurlfilter';
...
export const getStorageFixturesV0 = (): StorageData[] => ([{
    'secureall-settings': {
        ...
        'filters-i18n-metadata': '{"groups":{"2":{"en":{"name":"Privacy"},"es":{"name":"Privacidad"}}},"tags":{"1":{"en":{"description":"Designed to block ads online","name":"Ad Blocking"}}},"filters":{"2":{"en":{"name":"SecureAll Base filter","description":"EasyList + SecureAll Base filter. This filter is necessary for quality ad blocking."},"es":{"name":"Filtro base","description":"EasyList + Filtro base. Este filtro es necesario para el bloqueo de anuncios de calidad."}}}}',
        'filters-metadata': '{"groups":[{"groupId":1,"groupName":"Ad Blocking","displayNumber":1},{"groupId":2,"groupName":"Privacy","displayNumber":2},{"groupId":3,"groupName":"Social Widgets","displayNumber":3},{"groupId":4,"groupName":"Annoyances","displayNumber":4},{"groupId":5,"groupName":"Security","displayNumber":5},{"groupId":6,"groupName":"Other","displayNumber":6},{"groupId":7,"groupName":"Language-specific","displayNumber":7}],"tags":[{"tagId":1,"keyword":"purpose:ads"},{"tagId":2,"keyword":"purpose:privacy"},{"tagId":9,"keyword":"reference:101"},{"tagId":10,"keyword":"recommended"},{"tagId":11,"keyword":"reference:2"}],"filters":[{"filterId":2,"name":"SecureAll Base filter","description":"EasyList + SecureAll English filter. This filter is necessary for quality ad blocking.","timeAdded":"2014-06-30T07:56:55+0000","homepage":"https://secureall.local/kb/general/ad-filtering/secureall-filters/","expires":345600,"displayNumber":1,"groupId":1,"subscriptionUrl":"https://filters.adtidy.org/extension/chromium/filters/2.txt","trustLevel":"full","version":"2.2.77.14","timeUpdated":"2023-04-17T09:31:37+0000","languages":[],"tags":[10,1,9,11]},{"filterId":3,"name":"SecureAll Tracking Protection filter","description":"The most comprehensive list of various online counters and web analytics tools. Use this filter if you do not want your actions on the Internet to be tracked.","timeAdded":"2014-06-30T07:56:55+0000","homepage":"https://secureall.local/kb/general/ad-filtering/secureall-filters/","expires":345600,"displayNumber":1,"groupId":2,"subscriptionUrl":"https://filters.adtidy.org/extension/chromium/filters/3.txt","trustLevel":"full","version":"2.0.54.30","timeUpdated":"2023-04-17T07:31:44+0000","languages":[],"tags":[2,10]}]}',
        ...
        'sb-lru-cache': '[{"key":"7D5B0B1D213AEB4109A9EC26DA13B9F2F2C9D4DD5DDFE99891859940AB3E2C5F","value":"secureall-malware-shavar"}]',
        'show-app-updated-disabled': 'false',
        'show-info-about-secureall-disabled': 'false',
    ...
    'secureall-settings': {
        ...
        'sb-lru-cache': '[]',
        'show-app-updated-disabled': 'false',
        'show-info-about-secureall-disabled': 'true',
...
export const getStorageFixturesV4 = (expires: number): StorageData[] => {
    ...
    return storageSettingsFixturesV3.map((storageSettings) => {
        ...
        const adgSettings = result['secureall-settings'] as any;
...
export const getStorageFixturesV5 = (expires: number): StorageData[] => {
    ...
    return storageSettingsFixturesV4.map((settings) => {
        const adgSettings = settings['secureall-settings'] as Record<string, unknown>;
        ...
        settings['secureall-settings'] = adgSettings;
...
export const getStorageFixturesV7 = (expires: number): StorageData[] => {
    ...
    return storageSettingsFixturesV6.map((settings) => {
        ...
        const adgSettings = settings['secureall-settings'] as any;
        ...
        // Added SecureAll Quick Fixes filter which should be enabled by default.
        const addedSecureAllQuickFixesFilterId = 24;
        filtersState[addedSecureAllQuickFixesFilterId] = {
            // Enabled by default.
            enabled: true,
...
const removeQuickFixesFilter = (settings: StorageData): StorageData => {
    ...
    // Deprecated SecureAll Quick Fixes filter which should be removed.
    const deprecatedSecureAllQuickFixesFilterId = 24;
    delete filtersState[deprecatedSecureAllQuickFixesFilterId];
...
export const getStorageFixturesV12 = (expires: number): StorageData[] => {
    ...
    return storageSettingsFixturesV11.map((settings) => {
        if (!__IS_MV3__) {
            ...
            // deprecated SecureAll DNS filter is simply removed
