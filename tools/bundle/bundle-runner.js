...
export const bundleRunner = (webpackConfig, options) => {
    ...
    if (watch) {
        ...
        // changes in the @secureall dependencies and rebuilding vendors correctly.
