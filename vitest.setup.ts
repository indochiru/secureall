...
import { ResourceType } from '@secureall/tsurlfilter/es/declarative-converter';
...
vi.mock('@secureall/tswebextension', async () => ({
    ...(await vi.importActual('@secureall/tswebextension')),
